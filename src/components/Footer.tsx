  ...
  return (
    <footer className="bg-bastion-navy border-t border-bastion-border pt-16 pb-8 px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        {/* Brand Column */}
        <div className="col-span-1 md:col-span-1 border-r border-bastion-border pr-8">
          ...
          <p className="text-[11px] text-white font-bold leading-relaxed uppercase tracking-wider mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] font-black text-white uppercase tracking-widest italic font-mono">Sovereign Cloud // CA-CENTRAL-1</span>
          </div>
        </div>
        ...
        <div className="col-span-1 bg-bastion-navy p-6 rounded-xl border border-bastion-border">
          <h4 className="label-xs mb-4 text-white">Official Verification</h4>
          <div className="space-y-4">
            ...
            <button className="w-full mt-2 py-3 bg-bastion-navy border border-bastion-border rounded-lg text-[10px] font-black text-white hover:bg-white/5 transition-all uppercase tracking-widest italic leading-none">
      ...
      <div className="max-w-7xl mx-auto pt-8 border-t border-bastion-border flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 text-[10px] font-black text-white uppercase tracking-widest leading-none">
          <button onClick={() => onSelect('PRIVACY')} className="hover:text-bastion-sapphire transition-colors">Privacy Policy</button>
          <button onClick={() => onSelect('TERMS')} className="hover:text-bastion-sapphire transition-colors">Terms of Service</button>
          <button onClick={() => onSelect('COOKIE')} className="hover:text-bastion-sapphire transition-colors">Cookie Policy</button>
          <button onClick={() => onSelect('DMCA')} className="hover:text-bastion-sapphire transition-colors">DMCA</button>
          <button onClick={() => onSelect('DISCLAIMER')} className="hover:text-bastion-sapphire transition-colors">Legal Disclaimer</button>
        </div>
      </div>
    </footer>
  );
...
function RegulatoryItem({ label, onClick }: { label: string, onClick: () => void }) {
  return (
    <li className="flex items-center justify-between group cursor-pointer" onClick={onClick}>
      <span className="text-[10px] font-bold text-white group-hover:text-bastion-sapphire transition-colors uppercase tracking-tight">{label}</span>
      <ExternalLink size={10} className="text-slate-500 group-hover:text-bastion-sapphire transition-colors" />
    </li>
  );
}
...
function FooterLink({ label, onClick }: { label: string, onClick: () => void }) {
  return (
    <li className="flex items-center gap-2 group cursor-pointer text-[10px] font-bold text-white uppercase tracking-tight hover:text-bastion-sapphire transition-colors" onClick={onClick}>
